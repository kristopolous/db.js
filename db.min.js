(function(){function y(a){var d={};l(a,function(a){d[a]=!0});return d}function z(a,d){var c=arguments.length,b=c==1?a:d,h,e={};i.isArr(b)?(c=b.length,h=function(a){for(var e=0;e<c;e++)if(o(a,b[e])>-1)return!0;return!1}):h=function(a){return o(a,b)>-1};return c==2?(e={},e[a]=h,e):h}function u(a){return a.length?m.call(a):p(a)}function A(){var a=m.call(arguments),d,c,b,h,e,g,j,k={},f=u(i.isArr(this)?this:a.shift());a.length==2&&i.isStr(a[0])&&(b={},b[a[0]]=a[1],a=[n({},b)]);for(c=0;c<a.length;c++)if(d=
a[c],i.isFun(d)){d=d.single||d;k={};for(e=f.length,j=e-1;j>=0;j--){b=f[j];if(b in k){if(!k[b])continue}else if(!(k[b]=d(b)))continue;e-(j+1)&&(g=j+1,f.splice(g,e-g));e=j}g=j+1;e-g&&f.splice(g,e-g)}else l(d,function(a,c){if(i.isFun(c)){k={};for(e=f.length,j=e-1;j>=0;j--)b=f[j],a in b&&(h=b[a],c(h,b)&&(e-(j+1)&&(g=j+1,f.splice(g,e-g)),e=j))}else for(e=f.length,j=e-1;j>=0;j--)b=f[j],a in b&&b[a]===c&&(e-(j+1)&&(g=j+1,f.splice(g,e-g)),e=j);g=j+1;e-g&&f.splice(g,e-g)});return f}function B(){var a=y(m.call(arguments));
return function(d){for(var c in a)if(c in d)return!1;return!0}}function C(a,d){var c,b=arguments.length,h,e={};b==1?h=a:b==2&&(h=d);h=h.toString().toLowerCase();c=function(a){return a.toString().toLowerCase().search(h)>-1};return b==2?(e={},e[a]=c,e):c}function v(a){var d={x:a};return function(a,b){arguments.length==2&&(d[a]=b);return d[a]}}function q(a){var d={};l(a,function(a){d[a]=!0});return d}function p(a){var d=[],c;for(c in a)d.push(a[c]);return d}function n(a,d){for(var c,b,h,e,g=arguments.length,
j=0;j<g;j++){c=arguments[j];for(var k in c)b=a[k],h=c[k],a!==h&&(h&&(h.constructor==Object||(e=i.isArr(h)))?(e?(e=!1,b=b&&i.isArr(constructor)?b:[]):b=b&&b.constructor==Object?b:{},a[k]=n(b,h)):h!==void 0&&(a[k]=h))}return a}function D(a,d){var c=[],b;arguments.length==2?(b=a,a=d):b=this;if(i.isArr(b))c=w(b,a);else{var c={},h;for(h in b)i.isFun(b[h])||(c[h]=a.call(this,b[h]))}return c}var m=Array.prototype.slice,r=Object.prototype.toString,s={},x={},i={isFun:function(a){return!(!a||!a.constructor||
...
function(a,d){for(var c=[],b=0,h=obj.length;b<h;b++)c.push(d(obj[b],b));return c},l=[].forEach?function(a,d){if(i.isArr(a))a.forEach(d);else for(var c in a)d(c,a[c])}:function(a,d){if(i.isArr(a))for(var c=0,b=a.length;c<b;c++)d(a[c],c);else for(c in a)d(c,a[c])};l("< <= > >= == === != !==".split(" "),function(a){x[a]=Function("rhs","return function(x){return x"+a+"rhs}")});var F=function(){var a={};return function(d,c){var b,h=arguments.length,e=h==1?d:c||[],g={};e.length?e.length<20&&i.isNum(e[0])?
...
m.call(arguments));return a.length?a[0]:{}};f.select=function(a){var c=i.isArr(this)?this:f.find();resultList={};arguments.length>1?a=m.call(arguments):i.isStr(a)&&(a=[a]);len=a.length;l(a,function(a,b){if(a=="*")resultList=w(c,p);else for(var d=0,e=c.length;d<e;d++)row=c[d],a in row&&(e>1?(resultList[d]||(resultList[d]=[]),resultList[d][b]=row[a]):resultList[d]=row[a])});return b(p(resultList))};f.insert=function(a){var d={},f=[],g=[];arguments.length>1?f=m.call(arguments):i.isArr(a)?f=a:f.push(a);
e.unique&&l(k,function(a,b){d[a[e.unique]]=b});l(f,function(a){if(e.unique&&a[e.unique]in d)g.push(d[a[e.unique]]);else{var b=k.length,c;if(j){var f={};l(j,function(a,b){f[a]=i.isFun(b)?b():b});a=n(f,a)}try{c=new (v(b)),n(c,a),k.push(c)}catch(h){if(!unsafe)a.constructor=v(b);k.push(a)}g.push(b)}});c();return b(h(g))};f.update=function(a,d){var e=i.isArr(this)?u(this):f.find(),g;arguments.length==2&&i.isStr(a)&&(g=a,a={},a[g]=d);i.isFun(a)?l(e,a):l(a,function(a,b){i.isFun(b)?l(e,function(c){c[a]=b(c)}):
l(e,function(c){c[a]=b})});c();return b(e)};f.remove=function(a){var d,e,g=[];d=i.isArr(this)?this:i.isArr(a)?a:arguments.length>0?f.find(a):f.find();t.stain(d);d=k.length;for(var h=k.length-1;h>=0;h--)t.isStained(k[h])?g.push(k[h]):(d-(h+1)&&(e=h+1,k.splice(e,d-e)),d=h);e=h+1;d-e&&k.splice(e,d-e);c();return b(g)};if(arguments.length==1)if(i.isArr(a))f.insert(a);else if(i.isFun(a))f.insert(a());else if(i.isStr(a))return f.apply(this,arguments);else i.isObj(a)&&f.insert(a);else arguments.length>1&&
f.insert(m.call(arguments));f.__raw__=k;return f}})();
