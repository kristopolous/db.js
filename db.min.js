...
[],d=0,e=a.length;d<e;d++)b[d]=l[a[d]];return b}var e={},f=[],h=!1,k=!1,j=J(),l=[];p(j,{constrain:function(){var a=p,b=e,d;var c=arguments,o={};c.length==2?(o[c[0]]=c[1],d=o):c.length==1&&(d=c[0]);a(b,d)},each:t,findFirst:function(){var a=j.find.apply(this,n.call(arguments));return a.length?a[0]:{}},has:F,hasKey:function(){return j.find(x.apply(this,n.call(arguments))).invert()},isin:I,like:y,invert:function(a){var d=l,c=[];C(a||this);for(var a=0,e=d.length;a<e;a++)d[a].constructor("i")!=r&&c.push(d[a]);
return b(c)},map:t,missing:function(){return j.find(x.apply(this,n.call(arguments)))},sync:function(a){f.push(a)},template:{create:function(a){k=a},update:function(a){p(k||{},a)},get:function(){return k},destroy:function(){k=!1}},update:function(){var a=H.apply(i.isArr(this)?this:j.find(),n.call(arguments));d();return b(a)}});j.group=function(a){var d={};m(this,function(b){d[b[a]]||(d[b[a]]=[]);d[b[a]].push(b)});return b(d)};j.order=j.sort=function(a,d){var c,e=arguments.length,o,g=i.isArr(this)?
this:j.find();i.isFun(a)?c=a:i.isStr(a)&&(e==1?o="x-y":e==2&&(o=i.isStr(d)?{asc:"x-y",desc:"y-x"}[d.toLowerCase()]:d),i.isStr(o)&&(o=v[o]?v[o]:v[o]=new Function("x,y","return "+o)),c=function(d,b){return o(d[a],b[a])});return b(n.call(g).sort(c))};j.where=j.find=function(){return b(w.apply(this,arguments.length?[l].concat(n.call(arguments)):[l]))};j.view=function(a){var b={};j.sync(function(d){var c={},e;m(d,function(b){a in b&&(c[b[a]]=b)});for(e in c)e in b?b[e]!==c[e]&&(b[e]=c[e]):b[e]=c[e];for(e in b)e in
c||delete b[e]});d();return b};j.select=function(a){var d=i.isArr(this)?this:j.find(),c={};arguments.length>1?a=n.call(arguments):i.isStr(a)&&(a=[a]);m(a,function(a,b){if(a=="*")c=B(d,s);else for(var e=0,g=d.length;e<g;e++)row=d[e],a in row&&(g>1?(c[e]||(c[e]=[]),c[e][b]=row[a]):c[e]=row[a])});return b(s(c))};j.insert=function(a){var c={},f=[],h=[];arguments.length>1?f=n.call(arguments):i.isArr(a)?f=a:f.push(a);e.unique&&m(l,function(a,b){c[a[e.unique]]=b});m(f,function(a){if(e.unique&&a[e.unique]in
c)h.push(c[a[e.unique]]);else{var b=l.length,d;if(k){var g={};m(k,function(a,b){g[a]=i.isFun(b)?b():b});a=p(g,a)}try{d=new (z(b)),p(d,a),l.push(d)}catch(f){a.constructor=z(b),l.push(a)}h.push(b)}});d();return b(g(h))};j.remove=function(a){var c,e,g=[];c=i.isArr(this)?this:i.isArr(a)?a:arguments.length>0?j.find(a):j.find();C(c);var f=l.length-1;for(c=l.length;f>=0;f--)l[f].constructor("i")==r?g.push(l[f]):(c-(f+1)&&(e=f+1,l.splice(e,c-e)),c=f);e=f+1;c-e&&l.splice(e,c-e);d();return b(g)};if(arguments.length==
1)if(i.isArr(a))j.insert(a);else if(i.isFun(a))j.insert(a());else if(i.isStr(a))return j.apply(this,arguments);else i.isObj(a)&&j.insert(a);else arguments.length>1&&j.insert(n.call(arguments));j.__raw__=l;return j};p(DB,{find:w,each:t,like:y,reduceLeft:function(a,c){var d=i.isStr(c)?new Function("y,x","return y "+c):c;return function(b){for(var c=a,e=0,f=b.length;e<f;e++)b[e]&&(c=d(c,b[e]));return c}},reduceRight:function(a,c){c=DB.reduceLeft(a,c);return function(a){return c(a.reverse())}}})})();
