...
m.call(arguments));return a.length?a[0]:{}};f.select=function(a){var c=i.isArr(this)?this:f.find(),d={};arguments.length>1?a=m.call(arguments):i.isStr(a)&&(a=[a]);l(a,function(a,b){if(a=="*")d=w(c,p);else for(var e=0,f=c.length;e<f;e++)row=c[e],a in row&&(f>1?(d[e]||(d[e]=[]),d[e][b]=row[a]):d[e]=row[a])});return b(p(d))};f.insert=function(a){var d={},f=[],g=[];arguments.length>1?f=m.call(arguments):i.isArr(a)?f=a:f.push(a);e.unique&&l(k,function(a,b){d[a[e.unique]]=b});l(f,function(a){if(e.unique&&
a[e.unique]in d)g.push(d[a[e.unique]]);else{var b=k.length,c;if(j){var f={};l(j,function(a,b){f[a]=i.isFun(b)?b():b});a=n(f,a)}try{c=new (v(b)),n(c,a),k.push(c)}catch(h){if(!unsafe)a.constructor=v(b);k.push(a)}g.push(b)}});c();return b(h(g))};f.update=function(a,d){var e=i.isArr(this)?u(this):f.find(),g;arguments.length==2&&i.isStr(a)&&(g=a,a={},a[g]=d);i.isFun(a)?l(e,a):l(a,function(a,b){i.isFun(b)?l(e,function(c){c[a]=b(c)}):l(e,function(c){c[a]=b})});c();return b(e)};f.remove=function(a){var d,
