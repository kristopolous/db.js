...
function(a){L[a]=!0});K=L;self.DB=function(a,e){function b(){k||(k=!0,l(g,function(a){a.call(f,m)}),k=!1)}function c(a){for(var b in K)a[b]=f[b];return a}var d={},g=[],k=!1,j=!1,f=J(),m=[];p(f,{schema:function(){for(var a={},b=m.length,c,d=0;d<b;d+=10,c=m[d])for(var e in c)a[e]=void 0;return O(a)},constrain:function(){var a=p,b=d,c;c=arguments;var e={};2==c.length?(e[c[0]]=c[1],c=e):c=1==c.length?c[0]:void 0;a(b,c)},each:w,findFirst:function(){var a=f.find.apply(this,n.call(arguments));return a.length?
a[0]:{}},has:M,hasKey:function(){return this.find(B(n.call(arguments))).invert()},isin:y,like:C,invert:function(a){var b=m,d=[];G(a||this);a=0;for(var e=b.length;a<e;a++)b[a].constructor("i")==s||d.push(b[a]);return c(d)},map:w,missing:function(){var a=B(n.call(arguments));return h.isArr(this)?this.find(a):a},sync:function(a){a?g.push(a):b()},template:{create:function(a){j=a},update:function(a){p(j||{},a)},get:function(){return j},destroy:function(){j=!1}},update:function(){var a=N.apply(h.isArr(this)?
this:f.find(),n.call(arguments));b();return c(a)}});f.not=function(){return f.apply(this,n(arguments))};f.group=function(a){var b={},d=h.isArr(this)?this:f.find();l(d,function(d){a in d&&(b[d[a]]||(b[d[a]]=c([])),b[d[a]].push(d))});return b};f.keyBy=function(a){var b=f.group.apply(this,arguments);l(b,function(a,c){b[a]=c[0]});return b};f.order=f.sort=f.orderBy=function(a,b){var d,e=arguments.length,g,j=h.isArr(this)?this:f.find();h.isFun(a)?d=a:h.isStr(a)&&(1==e?g="x-y":2==e&&(g=h.isStr(b)?{asc:"x-y",
...
h.isArr(this)?this:f.find(),d,e={};1<arguments.length?a=n.call(arguments):h.isStr(a)&&(a=[a]);d=a.length;l(a,function(a,c){if("*"==a)e=F(b,v);else for(var f=0,g=b.length;f<g;f++)row=b[f],a in row&&(1<d?(e[f]||(e[f]=[]),e[f][c]=row[a]):e[f]=row[a])});return c(v(e))};f.insert=function(a){var e={},f=[],g=[];1<arguments.length?f=n.call(arguments):h.isArr(a)?f=a:f.push(a);l(f,function(a){if(d.unique&&(e={},l(m,function(a,b){e[a[d.unique]]=b}),a[d.unique]in e)){g.push(e[a[d.unique]]);return}var b=m.length,
c;if(j){var f={};l(j,function(a,b){f[a]=h.isFun(b)?b():b});a=p(f,a)}try{c=new (D(b)),p(c,a),m.push(c)}catch(k){a.constructor=D(b),m.push(a)}g.push(b)});b();for(var f=g,k=[],t=0,q=f.length;t<q;t++)k[t]=m[f[t]];return c(k)};f.remove=function(a,e){var d,g,j=[];d=h.isArr(this)?this:h.isArr(a)?a:0<arguments.length?f.find.apply(this,n.call(arguments)):f.find();G(d);var k=m.length-1;for(d=m.length;0<=k;k--)m[k].constructor("i")==s?j.push(m[k]):(d-(k+1)&&(g=k+1,m.splice(g,d-g)),d=k);g=k+1;d-g&&m.splice(g,
d-g);b();return c(j.reverse())};if(1==arguments.length)if(h.isArr(a))f.insert(a);else if(h.isFun(a))f.insert(a());else{if(h.isStr(a))return f.apply(this,arguments);h.isObj(a)&&f.insert(a)}else 1<arguments.length&&f.insert(n.call(arguments));f.__raw__=m;return f};p(DB,{find:u,each:w,like:C,trace:function(a,e){a.__$$tracer$$__={};l(a,function(b,c){h.isFun(c)&&(a.__$$tracer$$__[b]=c,a[b]=function(){console.log.apply(this,[b+":"].concat(n.call(arguments)));e&&e.apply(this,arguments);return a.__$$tracer$$__[b].apply(this,
arguments)})})},isin:y,objectify:function(a,e){var b=[];l(e,function(c){var d={};l(a,function(a,b){d[a]=c[b]});b.push(d)});return b},findFirst:function(){var a=u.apply(this,n.call(arguments));return a.length?a[0]:{}},reduceLeft:function(a,e){var b=h.isStr(e)?new Function("y,x","return y "+e):e;return function(c){for(var d=a,e=0,h=c.length;e<h;e++)c[e]&&(d=b(d,c[e]));return d}},reduceRight:function(a,e){e=DB.reduceLeft(a,e);return function(a){return e(a.reverse())}}})})();
