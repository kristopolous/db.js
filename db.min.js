...
d;a++)b[a].constructor("i")==s||e.push(b[a]);return c(e)},map:v,missing:function(){var a=A(n.call(arguments));return h.isArr(this)?this.find(a):a},sync:function(a){a?f.push(a):b();return pub},template:{create:function(a){j=a},update:function(a){q(j||{},a)},get:function(){return j},destroy:function(){j=!1}},update:function(){var a=N.apply(h.isArr(this)?this:g.find(),n.call(arguments));b();return c(a)}});g.not=function(){return g.apply(this,n(arguments))};g.group=function(a){var b={},e=h.isArr(this)?
this:g.find();l(e,function(e){a in e&&(b[e[a]]||(b[e[a]]=c([])),b[e[a]].push(e))});return b};g.keyBy=function(a){var b=g.group.apply(this,arguments);l(b,function(a,c){b[a]=c[0]});return b};g.order=g.sort=g.orderBy=function(a,b){var e,d=arguments.length,f,j=h.isArr(this)?this:g.find();h.isFun(a)?e=a:h.isStr(a)&&(1==d?f="x-y":2==d&&(f=h.isStr(b)?{asc:"x-y",desc:"y-x"}[b.toLowerCase()]:b),h.isStr(f)&&!G[f]&&(G[f]=new Function("x,y","return "+f)),eval("fnSort=function(a,b){return order(a."+a+", b."+a+
")}"));return c(n.call(j).sort(e))};g.where=g.find=function(){var a=n.call(arguments||[]);h.isArr(this)||(a=[m].concat(a));return c(t.apply(this,a))};g.view=function(a){var c={};g.sync(function(b){var e={},d;l(b,function(b){a in b&&(e[b[a]]=b)});for(d in e)d in c?c[d]!==e[d]&&(c[d]=e[d]):c[d]=e[d];for(d in c)d in e||delete c[d]});b();return c};g.select=function(a){var b=h.isArr(this)?this:g.find(),e,d={};1<arguments.length?a=n.call(arguments):h.isStr(a)&&(a=[a]);e=a.length;l(a,function(a,c){if("*"==
a)d=E(b,u);else for(var g=0,f=b.length;g<f;g++)row=b[g],a in row&&(1<e?(d[g]||(d[g]=[]),d[g][c]=row[a]):d[g]=row[a])});return c(u(d))};g.insert=function(a){var d,g={},f=[],k=[],f=1<arguments.length?n.call(arguments):h.isArr(a)?a:[a];l(f,function(a){var b=!0;e.unique&&(g={},l(m,function(a,b){g[a[e.unique]]=b}),a[e.unique]in g&&(k.push(g[a[e.unique]]),b=!1));l(e.addIf,function(c){b&=c(a)});if(b){d=m.length;var c;if(j){var f={};l(j,function(a,b){f[a]=h.isFun(b)?b():b});a=q(f,a)}try{c=new (C(d)),q(c,
a),m.push(c)}catch(n){a.constructor=C(d),m.push(a)}k.push(d)}});b();for(var f=k,L=[],p=0,r=f.length;p<r;p++)L[p]=m[f[p]];return c(L)};g.remove=function(a,e){var d,f,j=[];d=h.isArr(this)?this:h.isArr(a)?a:0<arguments.length?g.find.apply(this,n.call(arguments)):g.find();F(d);var k=m.length-1;for(d=m.length;0<=k;k--)m[k].constructor("i")==s?j.push(m[k]):(d-(k+1)&&(f=k+1,m.splice(f,d-f)),d=k);f=k+1;d-f&&m.splice(f,d-f);b();return c(j.reverse())};if(1==arguments.length)if(h.isArr(a))g.insert(a);else if(h.isFun(a))g.insert(a());
else{if(h.isStr(a))return g.apply(this,arguments);h.isObj(a)&&g.insert(a)}else 1<arguments.length&&g.insert(n.call(arguments));g.__raw__=m;return g};q(DB,{find:t,each:v,like:B,trace:function(a,d){a.__$$tracer$$__={};l(a,function(b,c){h.isFun(c)&&(a.__$$tracer$$__[b]=c,a[b]=function(){console.log.apply(this,[b+":"].concat(n.call(arguments)));d&&d.apply(this,arguments);return a.__$$tracer$$__[b].apply(this,arguments)})})},isin:x,objectify:function(a,d){var b=[];l(d,function(c){var d={};l(a,function(a,
b){d[a]=c[b]});b.push(d)});return b},findFirst:function(){var a=t.apply(this,n.call(arguments));return a.length?a[0]:{}},reduceLeft:function(a,d){var b=h.isStr(d)?new Function("y,x","return y "+d):d;return function(c){for(var d=a,f=0,h=c.length;f<h;f++)c[f]&&(d=b(d,c[f]));return d}},reduceRight:function(a,d){d=DB.reduceLeft(a,d);return function(a){return d(a.reverse())}}})})();
