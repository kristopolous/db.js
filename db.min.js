...
"try { return x "+h+"} catch(e) {}")),e[b]=d[h]);return e}}}}(),O=z("each find group has hasKey indexBy insert invert slice isin keyBy like missing order orderBy remove select sort unset update where".split(" "));self.DB=function(a,c){function d(){k||(k=!0,n(h,function(a){a.call(l,p)}),k=!1)}function b(a){for(var b in O)a[b]=l[b];return a}function f(a){for(var b=[],d=0,c=a.length;d<c;d++)b[d]=p[a[d]];return b}var e={addIf:[]},h=[],k=!1,m=!1,l=N(),p=[];r(l,{slice:function(){var a=g.isArr(this)?this:
l.find();return b(q.apply(a,arguments))},transaction:{start:function(){k=!0},end:function(){k=!1;d()}},schema:function(){for(var a={},b=p.length,d,c=0;c<b;c+=10,d=p[c])for(var e in d)a[e]=E;return M(a)},constrain:function(){var a=e,b;b=arguments;var d={};2==b.length?(d[b[0]]=b[1],b=d):b=1==b.length?b[0]:void 0;r(a,b)},addIf:function(a){a&&e.addIf.push(a);return e.addIf},beforeAdd:function(a){return l.addIf(a?function(){a.apply(0,arguments);return!0}:!1)},unset:function(a){if(g.isArr(a))return n(a,
arguments.callee);var c=g.isArr(this)?this:l.find();n(c,function(b){a in b&&delete b[a]});d();return b(c)},each:x,findFirst:function(){var a=l.find.apply(this,arguments);return a.length?a[0]:{}},has:K,hasKey:function(){return this.find(B(q.call(arguments))).invert()},isin:I,like:C,invert:function(a){return b(w(p,a||this))},map:x,missing:function(){var a=B(q.call(arguments));return g.isArr(this)?this.find(a):a},sync:function(a){a?h.push(a):d();return l},template:{create:function(a){m=a},update:function(a){r(m||
...
e[f][b]=row[a]):e[f]=row[a])});return b(s(e))};l.insert=function(a){var c,h={},l=[],k=[],l=1<arguments.length?q.call(arguments):g.isArr(a)?a:[a];n(l,function(a){var b=!0;e.unique&&(h={},n(p,function(a,b){h[a[e.unique]]=b}),a[e.unique]in h&&(k.push(h[a[e.unique]]),b=!1));n(e.addIf,function(d){b&=d(a)});if(b){c=p.length;var d;if(m){var f={};n(m,function(a,b){g.isFun(b)?f[a]=b():f[a]=b});a=r(f,a)}try{d=new (D(c)),r(d,a),p.push(d)}catch(l){a.constructor=D(c),p.push(a)}k.push(c)}});d();return b(f(k))};
l.remove=function(a,c){var e,f,h=[];e=g.isArr(this)?this:g.isArr(a)?a:0<arguments.length?l.find.apply(this,arguments):l.find();A(e);var k=p.length-1;for(e=p.length;0<=k;k--)p[k].constructor("i")==t?h.push(p[k]):(e-(k+1)&&(f=k+1,p.splice(f,e-f)),e=k);f=k+1;e-f&&p.splice(f,e-f);d();return b(h.reverse())};if(1==arguments.length)if(g.isArr(a))l.insert(a);else if(g.isFun(a))l.insert(a());else{if(g.isStr(a))return l.apply(this,arguments);g.isObj(a)&&l.insert(a)}else 1<arguments.length&&l.insert(q.call(arguments));
l.__raw__=p;return l};r(DB,{find:v,diff:w,each:x,like:C,trace:function(a,c){a.__trace__={};n(a,function(d,b){g.isFun(b)&&(a.__trace__[d]=b,a[d]=function(){console.log([d+":"].concat(q.call(arguments)));c&&c.apply(this,arguments);return a.__trace__[d].apply(this,arguments)})})},values:s,isin:I,copy:function(a){return JSON.parse(JSON.stringify(a))},objectify:function(a,c){var d=[];n(c,function(b){var c={};n(a,function(a,d){c[a]=b[d]});d.push(c)});return d},findFirst:function(){var a=v.apply(this,arguments);
return a.length?a[0]:{}},reduceLeft:function(a,c){var d=g.isStr(c)?new Function("y,x","return y "+c):c;return function(b){for(var c=a,e=0,g=b.length;e<g;e++)b[e]&&(c=d(c,b[e]));return c}},reduceRight:function(a,c){c=DB.reduceLeft(a,c);return function(a){return c(a.reverse())}}})})();
